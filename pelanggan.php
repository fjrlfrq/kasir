            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <button type="button" class="btn btn-info mb-4" data-toggle="modal" data-target="#myModal">Tambah Pelanggan</button>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$alamat;?></td>
                                            <td>
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idpl;?>">Edit</button>
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idpl;?>">Delete</button>
                                            </td>
                                        </tr>


                                    <!-- modal edit -->
                                        <div class="modal fade" id="edit<?=$idpl;?>" role="dialog">
                                        ...
                                        <!-- modal delete -->
                                        <div class="modal fade" id="delete<?=$idpl;?>" role="dialog">
                                            <div class="modal-dialog">
